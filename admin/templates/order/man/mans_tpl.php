...
<section class="content">
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text text-info font-weight-bold text-capitalize text-sm">Đang giao dịch</span>
                    <p class="info-box-text text-sm mb-0">Số lượng: <span class="text-danger font-weight-bold"><?= $allTradingOrder ?></span></p>
                    <p class="info-box-text text-sm mb-0">Tổng giá: <span class="text-danger font-weight-bold"><?= $func->formatMoney($totalTradingOrder) ?></span></p>
                </div>
            </div>
        </div>
    ...
    <div class="my-alert alert alert-info mt-3">Đơn hàng có thể thay đổi tùy thuộc vào tình trạng sản phẩm/gian hàng hoặc chủ sở hữu của sản phẩm/gian hàng.</div>
        ...
        <div class="card-body row">
            <div class="form-group col-md-3 col-sm-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control float-right" name="order_date" id="order_date" value="<?= (isset($_GET['order_date'])) ? $_GET['order_date'] : '' ?>" readonly>
                </div>
            </div>
            <div class="form-group col-md-3 col-sm-3">
                <label>Tình trạng:</label>
                <?= $func->orderStatus('main') ?>
            </div>
            <div class="form-group col-md-3 col-sm-3">
            ...
            <div class="form-group col-md-6 col-sm-6">
                ...
                <div class="px-5"><input type="text" class="primary" id="range_price" name="range_price"></div>
            </div>
    ...
    <div class="card-footer text-sm pb-5"><?= $paging ?></div>
</section>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#range_price').ionRangeSlider({
            ...
            from: <?= ($price_from) ? $price_from : 1 ?>,
            to: <?= ($price_to) ? $price_to : $maxTotal ?>,
            type: 'double',
            step: 1,
            // prefix  : 'đ ',
            postfix: ' đ',
